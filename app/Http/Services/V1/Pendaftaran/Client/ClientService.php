...
use App\Http\Repositories\V1\Pendaftaran\Client\ClientRepository;

class ClientService implements Interfaces
{
    public function __construct(private $repos = new ClientRepository()) {}
